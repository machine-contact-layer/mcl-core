...
| 30 | Final release bundle | `DONE` | Frozen developer archive built from the eight revisions in `releases/v1.0.0/commits.txt`; 49 artifacts. Private candidate only. Final audit metadata is sealed after execution without rebuilding the SDK archive. |
