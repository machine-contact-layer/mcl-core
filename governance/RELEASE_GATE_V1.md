...
| 31 | Reconstructability check | `DONE` | Bundle reconstruction passed on the final Public Candidate heads, 2026-09-13, including extracted SDK build and contract test: `RECONSTRUCTION VERIFIED`, exit 0. See `conformance/independent/20260913-public-candidate-seal/reconstruction.log`. The 2026-09-10 and 2026-09-12 receipts are retained unedited; each stopped being final evidence when the tree it qualified moved, most recently through the release-integrity fixes, the rows 27/37 closure and the adoption READMEs. |
| 32 | Final clean-room release rehearsal | `DONE` | 2026-09-13, on the final Public Candidate heads recorded in `HEADS.json`: POSIX rehearsal **22 checks passed, 0 failed**, exit 0; MSVC **44 test targets passed**, exit 0. Receipts in `conformance/independent/20260913-public-candidate-seal/`. Run unprivileged with a private empty `TMPDIR`. These gates include the hardened evidence-digest check, which requires each covered file's working tree to equal its committed blob before verifying a digest. Public CI on the final heads runs after this record merges, because the record itself moves `mcl-core`. |
| 33 | Final go/no-go audit | `DONE` | 2026-09-13 go/no-go on the final Public Candidate heads: **no fatal findings**, exit 0. See `conformance/independent/20260913-public-candidate-seal/go-no-go.log`. Row 36, public external review, remains open. |
