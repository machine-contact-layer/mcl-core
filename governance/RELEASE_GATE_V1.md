...
| 34 | Create `v1.0.0` | `WAIT_DEP` 27 | Every internally achievable row is DONE. Row 34a closed 2026-09-04; the release-closeout pass (API baseline, ledger repair, both gate halves, rebuilt bundle) closed 2026-09-05. |
