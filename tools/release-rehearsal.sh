...
echo "    V1_SCOPE.md section 5.9. Public external review is required"
echo "    before the Stable v1.0.0 tag; later external implementation"
echo "    reports may inform v1.1."
